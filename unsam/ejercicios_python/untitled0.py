...
#ang_sf * 24 / (2 * np.pi * freq_sf[350])#sinusoide está desfasado poco menos de 3hs respecto al seno neutro.
...
print(np.abs(fft_ba[0]))
#La disferencia de alturas es 111.83-88.21 = (23.62)
